...
{ id:'l1', n:{fr:'Niveau 1',en:'Level 1'},
  ...
  brief:{fr:"Novembre à Lyon, le quartier respire après la rentrée. Fermé le lundi et le dimanche soir. L'équipe est au complet et les besoins sont modestes : le vrai enjeu, c'est de coller aux contrats sans payer d'heures dans le vide. Léa a cours le mardi et le mercredi.",
    en:"November in Lyon, the neighbourhood quietens down after the autumn rush. Closed Mondays and Sunday evenings. The team is complete and demand is modest: the real challenge is matching the contracts without paying for hours nobody works. Léa has classes on Tuesday and Wednesday."},
...
{ id:'l3', n:{fr:'Niveau 3',en:'Level 3'},
  titre:{fr:'Juin, les Nuits de Fourvière',en:'June, the Fourvière festival'},
  sous:{fr:'10 salariés · budget sous tension',en:'10 staff · budget under pressure'},
  brief:{fr:"Le festival remplit la colline et la salle tourne midi et soir, sept jours sur sept. Tom est en arrêt jusqu'à mercredi inclus. Le budget est calé sur 31 % du chiffre d'affaires. Règle maison ce mois-ci : deux jours de repos consécutifs pour tout le monde.",
    en:"The festival fills the hill and the dining room turns over at lunch and dinner, seven days a week. Tom is on sick leave through Wednesday. Payroll is capped at 31% of revenue. House rule this month: two consecutive days off for everyone."},
...
const SEASON_WEEKS=[
 ...
 {nom:{fr:"Mars, premiers cars",en:"March, first coaches"},ca:14500,mult:.68,
  txt:{fr:"Les premiers groupes de touristes redescendent dans le Vieux Lyon. Les midis se remplissent, les soirs restent calmes.",
       en:"The first tour groups come back to the old town. Lunches fill up, evenings stay quiet."},
  ferme:[0], staff:['c1','c2','c3','s1','s4','s2']},
 ...
 {nom:{fr:"Mai, mariages",en:"May, wedding season"},ca:18000,mult:.84,
  ...
  ferme:[], staff:['c1','c2','c3','c4','s1','s4','s2','s5']},
 {nom:{fr:"Juin, le festival",en:"June, festival week"},ca:22000,mult:1.0,
  txt:{fr:"Les Nuits de Fourvière battent leur plein. La semaine la plus dense de la saison, midi et soir, tous les jours.",
       en:"The Fourvière festival is in full swing. The busiest week of the season, lunch and dinner, every day."},
  ferme:[], staff:['c1','c2','c3','c4','c5','s1','s4','s2','s5','s3','a1']},
 {nom:{fr:"Juin, après le festival",en:"June, after the festival"},ca:18500,mult:.86,
